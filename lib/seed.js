...
function makeBotPlayer(i) {
  ...
  const p = A.defaultPlayerJson({ name, origin: origin.id, gender: pick(WEAR.GENDERS), bio: '' });
  p.equip.wear = WEAR.randomOutfit(Math.random);            // NPC citizens dress themselves
...
module.exports = { seedWorld, makeBotPlayer, xpForLevel, purgeNPCs };
