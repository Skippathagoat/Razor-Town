...
module.exports = {
  attach, ensureTables, sys, weatherNow, currentEvent, challengeView, challengeClaim,
  ...
  gigDo, cityContractDo, cityContractBoard, courierTake, courierDeliver, fishCast, salvageRun, plasmaDonate, trialJoin, buskPlay,
