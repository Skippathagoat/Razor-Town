...
Run `node tools/check-2026.js` against a fresh world and all 164 end-to-end checks pass.

**Torn-style character system:** the bespoke character creator and the Rainlight part-engine are gone, replaced by the model Torn itself uses — a citizen is a **body** (male/female/enby, switched from Preferences) wearing **equipped clothing**. 41 wearable items sit on one of eight body parts at one of five layers (torso · legs · feet · head · eyes · mouth · neck · hands), one piece per part+layer seat, armour worn in the armour slot and drawn over everything. Buy clothes from the Market or the three new clothing shops (**The Rail**, **Gold Mile Jewellers**, **Foundry Surplus**), wear them from your bag, and the town sees them on your citizen everywhere — profile, attack list, fights, the cells. New citizens start dressed. The **🌃 Street Life** tab has been taken out entirely, along with the catalogs behind it; street heat still rises on crimes and cools on its own. **Night Briefs + Wire Favours expansion:** 1,000 extra playable night jobs (`lib/game/night-leads.js`), **600 extra Wire Favours** (`lib/game/wire-favours.js`) — quiet 4-hour rotation jobs on the hustle desk — a rebuilt streetwear/character rack (more skins, faces, hair, hoodies, bombers, snapbacks), and extra founder tools (god mode, fill bars, influence, followers, spawn all cars, jail-self, empty bag).
